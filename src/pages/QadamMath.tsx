...
function formatPhoneStable(prev: string, next: string, selectionStart: number | null): {
    value: string;
    caret?: number
} {
        ...
        <ThemeProvider theme={theme}>
                            ...
                            <motion.div {...appear(reduce)} initial="initial" animate="animate">
                                ...
                                >
                                    ...
                                    <Stack spacing={1.2} alignItems="center" sx={{position: "relative", zIndex: 1}}>
                                        <Typography component={motion.div} {...fadeUp(reduce)}
                                        ...
                                        <motion.div whileHover={!reduce ? {scale: 1.02, y: -1} : undefined}
                                                    whileTap={!reduce ? {scale: 0.98} : undefined}>
                                            <Button
                                                ...
                                                sx={{
                                                    ...
                                                    px: 3.8,
                                                    borderRadius: 999,
                                                    background: `linear-gradient(90deg,#101114, #191B20)`,
                            ...
                            >
                                <Box sx={{p: {xs: 2.5, md: 4}, position: "relative"}}>
                                    <Box component="img" src={IconGift} alt="" loading="lazy" decoding="async"
                                         sx={{
                                             position: "absolute", right: -8, top: -10, width: {xs: 100, md: 100},
            ...
            <Box sx={{py: {xs: 4, md: 6}}}>
                <Container>
                        ...
                        <Grid item xs={12} md={10} lg={9}>
                            <GlowCard bg={DARK} glow={CORAL}>
                                <Stack spacing={2} sx={{color: "#fff"}}>
                                    <Typography align="center" sx={{opacity: 0.95}}>Математика пәні бойынша
                                        өтеді.</Typography>
                                    <Typography>Олимпиаданы өткізудің негізгі мақсаттарының бірі Қазақстандағы балалар
                                        арасындағы Олимпиада қозғалысын дамыту болып табылады.</Typography>
                                    <Typography>Біз жас оқушылардың ой-өрісін кеңейтіп және білімге деген ұмтылысын
                                        ынталандырып, интеллектуалдық жарыстарға белсенді қатысуға шабыттандыруға
                                        тырысамыз.</Typography>
                                    <Typography>Олимпиадалық қозғалыс балаларға өз әлеуетін көрсетуге, күшті жақтарын
                                        анықтауға және болашақ табыстары үшін құнды тәжірибе болатын, аналитикалық және
                                        сынни дағдыларды дамытуға бірегей мүмкіндік береді.</Typography>
                                </Stack>
                            </GlowCard>
                        </Grid>
                    </Grid>
                    ...
                    <Typography align="center" sx={{fontWeight: 800, mb: 2}}>3-4-5 сынып оқушылары
                        қатысады!</Typography>
                    ...
                    <Grid container spacing={2} justifyContent="center" sx={{mb: 2}}>
                        {[{t: "1 орын", s: "iPhone 16"}, {
                            t: "2 орын",
                            s: "Яндекс Алиса Мини Станция 2 ақылды колонкасы"
                        }, {t: "3 орын", s: "Apple AirPods 3 құлаққаптары"}].map((x) => (
                    ...
                    <Grid container spacing={2} justifyContent="center" sx={{mb: 3}}>
                        {[{t: "4-10 орын", s: "Ozat Online-да тегін бір жылдық оқу"}, {
                            t: "11-50 орын",
                            s: "Ozat Online онлайн-курстарына 50% жеңілдік"
                        }].map((x) => (
                    ...
                    <GlowCard bg="#fff" glow={CORAL} pAll={0}>
                        <Box sx={{p: {xs: 2.5, md: 4}}}>
                            ...
                            <Typography align="center" color="text.secondary" sx={{mb: 3}}>
                                Тіркелгеннен кейін сізді біздің telegram-арнаға жібереді, ол жерде олимпиаданың барлық
                                жаңалықтары жарияланады.
                            ...
                            <Box component="form" noValidate onSubmit={onSubmit}>
                                <Stack spacing={2}>
                                    ...
                                    <FormControl fullWidth>
                                        <InputLabel id="target">Балаңыздың еліміздің үздік мектептеріне (НЗМ, БИЛ, РФММ)
                                            түсуін қалайсыз ба?</InputLabel>
                                        <Select
                                            labelId="target"
                                            label="Балаңыздың еліміздің үздік мектептеріне (НЗМ, БИЛ, РФММ) түсуін қалайсыз ба?"
                                            value={lead.target}
                                            onChange={(e) => setLead((s) => ({
                                                ...s,
                                                target: e.target.value as LeadState["target"]
                                            }))}
                                        >
                                            {["-", "Иә", "Жоқ", "Әлі білмеймін"].map((o) => <MenuItem key={o}
                                                                                                      value={o}>{o}</MenuItem>)}
                                        </Select>
                                    </FormControl>

                                    <motion.div whileHover={!reduce ? {y: -2, scale: 1.02} : undefined}
                                                whileTap={!reduce ? {scale: 0.98} : undefined}>
                                        <Button
                                            size="large"
                                            type="submit"
                    ...
                    <Stack direction={{xs: "column", sm: "row"}} spacing={2}
                        ...
                        <Stack direction="row" spacing={2}>
                            {["Политика конфиденциальности", "Публичная оферта"].map((t) => (
                                <Box key={t} component={motion.div}
                                     whileHover={!reduce ? {y: -1, scale: 1.04} : undefined}
                                     whileTap={!reduce ? {scale: 0.98} : undefined}>
